...
\end{itemize} 
\paragraph{}An example of a game that can be represented in extensive form is the sharing game, where two players try to decide how they can split $2\$$ in between them as shown in figure \ref{fig:scaled_diss}.
\begin{figure}[h]
